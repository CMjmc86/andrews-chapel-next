    ...
    <>
      ...
      >
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          <div className="text-[11px] uppercase tracking-[0.22em] text-[#D4AF37] mb-3">About Us</div>
          <h1 className="font-serif text-4xl sm:text-5xl font-bold text-white mb-4">About Andrews Chapel</h1>
          <p className="text-white/60 max-w-xl mx-auto leading-relaxed">
            Rooted in the A.M.E. Zion tradition, we are a family of faith serving the Bunnlevel community under the leadership of Pastor Kathy Grace.
          </p>
        </div>
      </section>
