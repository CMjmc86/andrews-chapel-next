...
export default function JoinPage() {
  ...
  const [form, setForm] = useState({
    ...
    ministry_interest: "", ministry_interest_other: "",
    testimony: "", notes: "",
  });
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    const { error: sbError } = await supabase.from("join_applications").insert([{
      ...
      how_joining: form.how_joining || null,
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        {form.ministry_interest === "Other" && (
          <Field label="Please describe where you'd like to serve">
            <input
              name="ministry_interest_other"
              value={form.ministry_interest_other}
