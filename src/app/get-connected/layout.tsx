...
export default function GetConnectedLayout({ children }: { children: React.ReactNode }) {
    ...
    <>
      ...
      >
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          <div className="text-[11px] uppercase tracking-[0.22em] text-[#D4AF37] mb-3">Get Connected</div>
          <h1 className="font-serif text-4xl sm:text-5xl font-bold text-white mb-4">We&apos;d Love to Meet You</h1>
      ...
      <div className="border-b" style={{ borderColor: "rgba(212,175,55,0.15)", background: "#000D26" }}>
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          <nav className="flex flex-wrap justify-center gap-1 -mb-px">
  {tabs.map((tab) => {
    ...
    return (
      <Link
        key={tab.href}
        href={tab.href}
        className="px-3 sm:px-5 py-3 text-sm font-medium whitespace-nowrap border-b-2 transition-colors"
        style={{
